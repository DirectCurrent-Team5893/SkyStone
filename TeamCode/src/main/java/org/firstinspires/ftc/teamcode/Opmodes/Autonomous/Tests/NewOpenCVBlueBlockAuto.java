...
@Autonomous(name="BlueBlockAutoTest", group ="Concept")
public class NewOpenCVBlueBlockAuto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //detector = new SkystoneDetectorExample(this, true, 45, 45, 45, 45, 45, 54);
