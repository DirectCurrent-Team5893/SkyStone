 ...
 */
        ...
        telemetry.update();
        encoderDrive(.6, 48.25,-48.25,48.25,48.25,60);
        ...
        telemetry.addData("Strafe Right 43 inches", "Complete");
        ...
        telemetry.addData("Move Backward 18 inches to the foundation", "Complete");
    }
